module safecrack ( 
   ...
   always_ff @(posedge clk or posedge rst) begin
      if (rst) begin
         ...
         else if (state == WRONG)   was_correct <= 1'b0;
      end
   end
